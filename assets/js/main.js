...
(function () {
  ...
  var SNS_ICONS = {
    ...
    dokusyokai: '<svg viewBox="0 0 24 24" fill="#E8913A" stroke="none"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/><rect x="5" y="7" width="4" height="1.5" rx=".75" fill="white"/><rect x="5" y="10" width="3" height="1.5" rx=".75" fill="white"/><rect x="15" y="7" width="4" height="1.5" rx=".75" fill="white"/><rect x="15" y="10" width="3" height="1.5" rx=".75" fill="white"/></svg>',
    kokucheese: '<svg viewBox="0 0 24 24" fill="#4A90D9" stroke="none"><rect x="3" y="4" width="18" height="18" rx="2"/><rect x="3" y="4" width="18" height="5" rx="2" fill="#3B78C0"/><rect x="7" y="2" width="2" height="4" rx="1" fill="#3B78C0"/><rect x="15" y="2" width="2" height="4" rx="1" fill="#3B78C0"/><rect x="6" y="12" width="3" height="3" rx=".5" fill="white"/><rect x="10.5" y="12" width="3" height="3" rx=".5" fill="white"/><rect x="15" y="12" width="3" height="3" rx=".5" fill="white"/><rect x="6" y="16.5" width="3" height="3" rx=".5" fill="white"/><rect x="10.5" y="16.5" width="3" height="3" rx=".5" fill="white"/></svg>'
  };
