...
| リンク | URL |
|---|---|
| 本番サイト | [https://reading-club-hp.netlify.app/](https://reading-club-hp.netlify.app/) |
| Netlify 管理画面 | [https://app.netlify.com/teams/71kaiji/projects](https://app.netlify.com/teams/71kaiji/projects) |
| GitHub リポジトリ | [https://github.com/dan-yuta/reading-club-hp](https://github.com/dan-yuta/reading-club-hp) |
| Notion ドキュメント | [実装アーキテクチャ・設計思想・開発履歴](https://www.notion.so/LP-3094fafd667380bdab76eb2f9a114189) |
...
> 詳細（カラーパレット・フォント・レスポンシブ・アニメーション・セクション別レイアウト等）は上記リンク集の Notion ドキュメントを参照してください。
...
2. ブラウザが自動で `http://localhost:3000` を開く
...
│   └── sitemap.xml         # サイトマップ
├── _dev/                   # ローカル開発用
│   ├── start-server.bat    # Node.js サーバー起動（ダブルクリック）
│   ├── stop-server.bat     # サーバー停止
│   └── server.ps1          # PowerShell 簡易HTTPサーバー
├── prompts/                # AI プロンプト
│   ├── HP作成用プロンプト.md
│   └── 画像生成プロンプト.md
